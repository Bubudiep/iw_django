...
router.register(r'nv_sorting', api.NhanvienSortingViewSet, basename='nv_sorting')
...
urlpatterns = [
    ...
    path('joinres-order/', api.UserAcceptItemOrderAPIView.as_view(), name='joinres-order'),
